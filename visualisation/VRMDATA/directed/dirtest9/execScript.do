...
vsim -GERRNO=9 -GINPUT_FILE_NAME=/media/sf_VSN/Macchi/VSN_Labo3/visualisation/src_tb/input_values.txt work.spike_detection_tb
run -all
coverage attribute -name ERRNO -value dirtest9
coverage save ../dirtest9.ucdb
