...
vsim -GERRNO=5 -GINPUT_FILE_NAME=/media/sf_VSN/Macchi/VSN_Labo3/visualisation/src_tb/input_values.txt work.spike_detection_tb
run -all
coverage attribute -name ERRNO -value dirtest5
coverage save ../dirtest5.ucdb
